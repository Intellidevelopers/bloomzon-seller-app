...
const Gallery = () => {
  ...
  const [media, setMedia] = useState<(string | null)[]>([null, null, null, null, null, null]);
  const [isVideo, setIsVideo] = useState<boolean[]>([false, false, false, false, false, false]);
    ...
    <GestureHandlerRootView style={styles.container}>
      ...
      <ScrollView>
        ...
        <Text style={styles.descriptionText}>
          Upload clear and high-quality images and a video of your product. Good photos attract more customers and help them make informed buying decisions. You can add up to 5 images and a video.
        </Text>
          ...
          {media.map((item, index) => (
            <View key={index} style={styles.imageWrapper}>
              {item ? (
                ...
                >
                  <MaterialCommunityIcons name="file-image-plus" size={40} color="#888" />
                </TouchableOpacity>
              )}
            </View>
          ))}
      ...
      <TouchableOpacity style={styles.saveButton} onPress={() => router.push('/ProductDescription')}>
