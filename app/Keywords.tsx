...
import { View, Text, TextInput, TouchableOpacity, StyleSheet, ScrollView, SafeAreaView, FlatList, Dimensions } from 'react-native';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollViewContent}>
        ...
        <Text style={styles.subtitle}>
          Enhance your product's visibility and search ranking by adding and managing relevant keywords. Use specific and targeted keywords to attract more potential buyers and boost your sales.
        </Text>
        ...
        />
        <TouchableOpacity style={styles.button} onPress={() => { router.push('/UploadSuccess') }}>
