  ...
  return (
    <View style={styles.container}>
     <View style={{ flexDirection: "row", alignItems: "center", marginTop: -30, justifyContent: "space-between"}}>
        ...
        <Text style={{ fontSize: 18, fontFamily: "Semibold", top: 25 }}>Profile</Text>
        <Text style={styles.backButton2}></Text>
      </View>
      
     <ScrollView showsVerticalScrollIndicator={false}>
      <View style={styles.profileContainer}>
          <Image style={styles.profileImage} source={{ uri: 'https://randomuser.me/api/portraits/men/45.jpg' }} />
      ...
      <View style={styles.settingsContainer}>
        ...
        <TouchableOpacity style={styles.settingItem}>
          <Text style={styles.settingText}>Activate / deactive auto sell </Text>
          <AntDesign name="right" size={20} color="black" />
        </TouchableOpacity>
        <TouchableOpacity style={styles.settingItem}>
