    ...
    <SafeAreaView style={styles.container}>
      ...
      <Animated.View style={[styles.drawer, { transform: [{ translateX: drawerTranslation }] }]}>
        <View style={styles.sidebar}>
          <Text style={styles.sidebartitle}><Text style={{ color: "#FF8C00" }}>Bloomzon</Text> Seller</Text>
          <TouchableOpacity>
              <MaterialIcons name="cancel" size={30} color="#000" />
          </TouchableOpacity>
        </View>
          
        <View style={{flexDirection: "row", alignItems: "center", borderBottomWidth: 1, borderBottomColor: "#ddd", marginBottom: 20}}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.drawerContent}>
          ...
          <TouchableOpacity style={{borderBottomWidth: 1, borderBottomColor: "#ddd", marginBottom: 18}} onPress={() => router.push('/LoginScreen')}>
      ...
      <SafeAreaView style={styles.mainContent}>
        ...
        <TouchableOpacity onPress={toggleDrawer}>
          ...
          <MaterialCommunityIcons name="line-scan" size={20} color="#000" style={{
            backgroundColor: "#eee",
            padding: 15,
            borderRadius: 100
          }} />
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <Modal visible={isDropdownVisible} transparent animationType="slide">
              <TouchableOpacity style={styles.modalOverlay} onPress={() => setDropdownVisible(false)}>
                <View style={styles.modalContent}>
                  {['6 months', 'Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'].map((month) => (
          ...
          <View style={{ flexDirection: "row", justifyContent: "space-evenly", marginTop: 20 }}>
            ...
            <TouchableOpacity style={styles.tabsContainer}>
              <View style={styles.tabContent}>
                <FontAwesome6 name='graduation-cap' size={30} color='#00D1A3' style={{ marginBottom: 10 }} />
          ...
          <View style={{ flexDirection: "row", justifyContent: "space-evenly", marginTop: 20 }}>
            <TouchableOpacity style={styles.tabsContainer}>
              <View style={styles.tabContent}>
                <FontAwesome6 name='repeat' size={30} color='#00D1A3' style={{ marginBottom: 10 }} />
            ...
            <TouchableOpacity style={styles.tabsContainer}>
              <View style={styles.tabContent}>
                <FontAwesome6 name='circle-info' size={30} color='#00D1A3' style={{ marginBottom: 10 }} />
          ...
          <View style={{ flexDirection: "row", justifyContent: "space-evenly", marginTop: 20 }}>
            <TouchableOpacity style={styles.tabsContainer}>
              <View style={styles.tabContent}>
                <MaterialIcons name='reviews' size={30} color='#00D1A3' style={{ marginBottom: 10 }} />
