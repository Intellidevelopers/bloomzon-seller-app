...
const Offers = () => {
  ...
  const [selectedFulfillment, setSelectedFulfillment] = useState('Bloomzon Pickup');
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.progressContainer}>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', left: 15, marginBottom: 25 }}>
            <Ionicons name="alert-circle-outline" color={'#666'} size={20} style={{ marginRight: 5 }} />
            <Text style={{ fontFamily: 'Regular', color: '#666' }}>Once submitted, it cannot be changed.</Text>
        </View>
        ...
        <View style={{ marginBottom: 20 }}>
          ...
          <View style={styles.quantityContainer}>
            ...
            />
            <TouchableOpacity style={styles.incrementButton} onPress={() => setQuantity(quantity + 1)}>
    ...
    <Text style={styles.subtitle}>Fulfillment channel</Text>
      ...
      <Pressable style={styles.fulfillmentOption} onPress={() => setSelectedFulfillment('Bloomzon Ship')}>
        <View style={styles.radioContainer}>
          <View style={[styles.radioButton, selectedFulfillment === 'Bloomzon Ship' && styles.radioSelected]} />
          <Text style={styles.radioText}>Bloomzon Ship</Text>
        </View>
        <Text style={styles.fulfillmentText}>You store your products in the nearest Bloomzon warehouse, and we take care of shipping to your customers.</Text>
      </Pressable>

      <Pressable style={styles.fulfillmentOption} onPress={() => setSelectedFulfillment('Bloomzon Pickup')}>
        <View style={styles.radioContainer}>
          <View style={[styles.radioButton, selectedFulfillment === 'Bloomzon Pickup' && styles.radioSelected]} />
          <Text style={styles.radioText}>Bloomzon Pickup</Text>
        </View>
        <Text style={styles.fulfillmentText}>You store and pack orders at your location. We pick them up from the provided address and deliver them to customers.</Text>
      </Pressable>

      <Pressable style={styles.fulfillmentOption} onPress={() => setSelectedFulfillment('Self Ship')}>
        <View style={styles.radioContainer}>
          <View style={[styles.radioButton, selectedFulfillment === 'Self Ship' && styles.radioSelected]} />
          <Text style={styles.radioText}>Self Ship</Text>
        </View>
        <Text style={styles.fulfillmentText}>You store and pack orders at your location. Then, you deliver them to customers yourself or use a third-party courier.</Text>
      </Pressable>
        <View style={{marginBottom: 20}}></View>

        
        <TouchableOpacity style={styles.loginButton} onPress={() => router.push('/Gallery')}>
